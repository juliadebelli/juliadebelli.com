...
const images = [
    { src: 'assets/1972.png', answers: ['1972', '72', 'munich', 'munchen', 'munique', 'alemanha'] },
    ...
    { src: 'assets/2012.svg', answers: ['2012', '12', 'londres', 'london', 'inglaterra'] },
...
function showCompletionPopup() {
    ...
    popup.innerHTML = `
        <p>Parabéns! Sua pontuação foi ${score}/15.</p>
